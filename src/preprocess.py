...
RATING_FILE_NAME = dict({'movie': 'ratings.dat', 'book': 'BX-Book-Ratings.csv', 'news': 'ratings.txt', 'music': 'user_artists.dat', 'ZL-CTR': 'BX-triplets-Ratings.csv'})
SEP = dict({'movie': '::', 'book': ';', 'news': '\t', 'music': '\t', 'ZL-CTR': ';'})
THRESHOLD = dict({'movie': 4, 'book': 0, 'news': 0, 'music': 0 ,'ZL-CTR': 0})
